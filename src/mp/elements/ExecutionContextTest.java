...
public class ExecutionContextTest extends TestCase {
  ...
  /**Ïðîâåðÿåòñÿ îñòàíîâêà ðàáîòû ìîäåëè ñ âûçîâîì ôóíêöèè StopExecution èçíóòðè áëîêà â îñòàíàâëèâàåìîé ìîäåëè
   * Ðåçóëüòàò ðàáîòû ïðîöåäóðû îñòàíîâêè ìîäåëè çàïèñûâàåòñÿ â îòäåëüíóþ ïåðåìåííóþ
   */
  ...
  public void testInnerStop_NoResult(){
    ...
    manager = mp.parser.ModelExecutionContext.GetManager("Ìîäåëü1");
  ...
  public void testInnerStop_ManageAnotherModel(){
    ...
    assertTrue( f );
    assertTrue( model != null );
    //ïðîâåðÿåì, ïðèñóòñòâóþò ëè â ñïèñêå ìîäåëåé îáå ìîäåëè
    ModelExecutionManager manager = null;
    manager = mp.parser.ModelExecutionContext.GetManager("Ìîäåëü1");
    assertTrue( manager != null );
    manager = mp.parser.ModelExecutionContext.GetManager("Ìîäåëü3");
    assertTrue( manager == null );
    manager = mp.parser.ModelExecutionContext.GetManager("Ìîäåëü2");
    assertTrue( manager != null );
  ...
  /**Ïðîâåðêà îøèáî÷íîé ñèòóàöèè: ñîçäàåòñÿ êîðíåâàÿ ìîäåëü è äâå äðóãèõ ìîäåëè, êîòîðûå èìåþò îäèíàêîâûé íîìåð.
   * Ñèñòåìà äîëæíà âûäàòü îøèáêó ïðè ðàçáîðå ìîäåëè
   */
  ...
  /**ïðîâåðêà òðîéíîãî óðîâíÿ âëîæåííîñòè ìîäåëåé
   *
   */
  public void test3Level(){
    ...
    f = false;
    ModelExecutionManager manager = null;
    manager = ModelExecutionContext.GetManager("Ìîäåëü1");
    assertTrue( manager != null );
    manager = ModelExecutionContext.GetManager("Ìîäåëü2");
    assertTrue( manager != null );
    manager = ModelExecutionContext.GetManager("Ìîäåëü3");
    assertTrue( manager != null );
  ...
  /**Ïðîâåðÿåòñÿ ïðàâèëüíîñòü ðàáîòû ôóíêöèè ñêðèïòà SetToInitConditions() âíóòðè îäíîé ìîäåëè è áåç
   * ñòýéò÷àðòà
   *
   */
  ...
  public void testSetToInit_SubModel(){
    ...
    assertTrue( f );
    ModelExecutionManager manager = ModelExecutionContext.GetManager("Ìîäåëü2");
    assertTrue( manager != null );
    //ModelBlock
  }

  /**Ïðîâåðÿåòñÿ ïðàâèëüíîñòü ïîëó÷åíèÿ äàííûõ èç äðóãîé ìîäåëè
   *
   */
  ...
  /**ïðîâåðÿåòñÿ ïðàâèëüíîñòü ðàáîòû ôóíêöèè Get â óñëîâèÿõ, êîãäà èíäåêñ áëîêà äàí â âèäå ïåðåìåííîé,
   * à íå êîíñòàíòû
   *
   */
  ...
  /**
   * ïðîâåðÿåì âîçìîæíîñòü ïîäêëþ÷åíèÿ ê áëîêàì îñíîâíîé ìîäåëè èç áëîêîâ ìîäåëè, êîòîðàÿ ïîäêëþ÷åíà èç ñåêöèè <ModelList><ParallelModel
   */
  public void testConnectBlocks_FromParallelModel(){
    ...
    assertTrue( f );
    Model mainModel = (Model) ModelExecutionContext.GetManager( "Ìîäåëü18" );
    Model subModel = (Model) ModelExecutionContext.GetManager( "Ìîäåëü18_1" );
  ...
  /////////////////////////////////////////////////////////////////////////
  ///////// òåñòèðóåì êîíñòàíòû â ìîäåëè //////////////////////////////////
  /////////////////////////////////////////////////////////////////////////

  /**ïðîâåðÿåòñÿ ïðîñòîå ñîçäàíèå êîíñòàíòû èç ôàéëà ìîäåëè, åå ïîëó÷åíèå
   * èç ìîäåëè
   *
   */
  ...
  /**ïðîâåðÿåòñÿ ïðàâèëüíîñòü îòðàáîòêè êîíñòàíòû â àòðèáóòå initvalue ïàðàìåòðà áëîêà
   *
   */
  ...
  /**ïðîâåðÿåòñÿ ïðàâèëüíîñòü îáðàáîòêè êîíñòàíò âíóòðè ñêðèïòîâ
   *
   */
  ...
  /////////////////////////////////////////////////////////////////////////
  ///////// òåñòèðóåì âîçìîæíîñòü âûïîëíåíèÿ îäíîé è òîé æå ìîäåëè îäíîâðåìåííî, íî â ðàçíûõ ïîòîêàõ //////////////////////////////////
  /////////////////////////////////////////////////////////////////////////
 public static String syncFlag = "123";
 public static Model globalModel = null;
  
  /**
   * Ïðîâåðêà âîçìîæíîñòè äâîéíîãî çàïóñêà îäíîé è òîé æå ìîäåëè
   */
