...
public class Lorenz extends Applet {
  ...
  private GraphicsPlotCanvas createPlotCanvas(boolean graphics2D) {
    ...
    props.put("plot/curveFactory/definitions", "_curve");
    props.put("plot/curveFactory/_curve/initialHintForNextPoint/className",
              "jcckit.plot.ShapeAttributesHint");
    props.put("plot/curveFactory/_curve/initialHintForNextPoint/"
              + "initialAttributes/fillColor", "0x50a");
    props.put("plot/curveFactory/_curve/initialHintForNextPoint/"
              + "fillColorHSBIncrement", "0.0 0.0 0.018");
    props.put("plot/curveFactory/_curve/withLine", "false");
    props.put("plot/curveFactory/_curve/symbolFactory/className",
              "jcckit.plot.CircleSymbolFactory");
    props.put("plot/curveFactory/_curve/symbolFactory/size", "0.015");
